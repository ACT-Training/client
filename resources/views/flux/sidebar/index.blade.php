...
@php
    ...
    if ($stashable) {
        $attributes = $attributes
            ...
            ->class(['max-lg:data-mobile-cloak:hidden', 'lg:translate-x-0! [[data-show-stashed-sidebar]_&]:translate-x-0!', 'z-20! data-stashed:fixed! data-stashed:start-0! data-stashed:top-0! data-stashed:max-h-dvh! data-stashed:min-h-dvh!']);
    }
@endphp
