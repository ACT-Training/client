...
<ui-option action {{ $attributes->class($classes) }} data-flux-command-item>
    ...
    <div class="relative">
        ...
        <flux:icon
            :$icon
            :variant="$iconVariant"
            class="me-2 size-6 text-zinc-400 group-data-active/item:text-zinc-800 dark:text-zinc-400 dark:group-data-active/item:text-white"
        />
    ...
    <div class="ms-auto inline-flex rounded-sm bg-zinc-800/5 px-1 py-0.5 dark:bg-white/10">
        <span class="text-xs font-medium text-zinc-500 dark:text-zinc-300">{{ $kbd }}</span>
    </div>
