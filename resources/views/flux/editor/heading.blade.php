...
<ui-select data-editor="heading" class="relative">
    <flux:tooltip content="{{ __('Styles') }}" :$kbd class="contents">
        <flux:editor.button>
            <ui-selected>
                ...
                >
                    <path
                        d="M3.33331 5.83398V3.33398H16.6666V5.83398"
                        stroke="currentColor"
                        stroke-width="1.5"
    ...
    <ui-options
        ...
        class="min-w-[10rem] rounded-lg border border-zinc-200 bg-white p-[5px] shadow-xs dark:border-zinc-600 dark:bg-zinc-700"
    >
